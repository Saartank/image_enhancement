...
method_name = "Mimo_Jun20_separate_enc_model"
...
test_loader = dataloader.anv_testDataLoader(input_evs=[(0,1),(4,1),(-20,1)])
test_id=0
...
for data in test_loader:
    ...
    save_path = f'{result_dir}/{decoded_path}/{method_name}_new_21epoch {decoded_path}.jpg'
